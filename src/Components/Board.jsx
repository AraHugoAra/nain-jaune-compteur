...
function Board() {
  const [players, setPlayers] = useState([
    { playerName: undefined, money: 0, id: 0 },
  ]);
  const [trumps, setTrumps] = useState([
    { trumpName: "ten", money: 0, bet: 1 },
  ...
  function AddPlayer() {
    setPlayers([
      ...players,
      { playerName: undefined, money: 0, id: lastPlayerAdded.id + 1 },
    ]);
  }
    ...
    <div className="container__main">
      ...
      <div className="container__main--buttons">
        <Button
          ...
          onClick={() => AddPlayer()}
        >
          <PersonAddAlt1Icon className="button__icon" />
          Joueur
        </Button>
        <Bets
          trumps={trumps}
